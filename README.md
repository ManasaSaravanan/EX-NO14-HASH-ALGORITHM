...
3. Message Preprocessing:
   ...
   - For example, in SHA-256, the message is padded to ensure that its length is a multipl# EX-NO14-HASH-ALGORITHM
...
```
## Output:
<img width="1638" height="771" alt="image" src="https://github.com/user-attachments/assets/c85f4dad-480a-4e69-9300-42a6af04628d" />
